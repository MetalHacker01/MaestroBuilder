...
export const bodyThreeColumns: Module = {
  ...
  schema: {
    ...
    col1Icon: { type: "image-url", label: "Icon 1 URL", default: "https://placehold.co/80x80/F7F6F3/111111/png?text=1", group: "Column 1" },
    ...
    col2Icon: { type: "image-url", label: "Icon 2 URL", default: "https://placehold.co/80x80/F7F6F3/111111/png?text=2", group: "Column 2" },
    ...
    col3Icon: { type: "image-url", label: "Icon 3 URL", default: "https://placehold.co/80x80/F7F6F3/111111/png?text=3", group: "Column 3" },
